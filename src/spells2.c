...
void
cast_armor (byte level, struct char_data *ch, char *arg, int type,
...
void
cast_teleport (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_damage_up (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_crush_armor (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_bless (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_blindness (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_create_food (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
...
void
cast_create_water (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_create_nectar (byte level, struct char_data *ch, char *arg, int type,
		    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_create_golden_nectar (byte level, struct char_data *ch, char *arg, int type,
			   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_cure_blind (byte level, struct char_data *ch, char *arg, int type,
		 struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_mana_boost (byte level, struct char_data *ch, char *arg, int type,
		 struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_vitalize (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_trick (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_cause_critic (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_cure_critic (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_cause_light (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_cure_light (byte level, struct char_data *ch, char *arg, int type,
		 struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_curse (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_detect_evil (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_detect_invisibility (byte level, struct char_data *ch, char *arg, int type,
			  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_preach (byte level, struct char_data *ch, char *arg, int type,
	     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_dispel_evil (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_recharger (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_enchant_weapon (byte level, struct char_data *ch, char *arg, int type,
		     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_enchant_person (byte level, struct char_data *ch, char *arg, int type,
		     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_enchant_armor (byte level, struct char_data *ch, char *arg, int type,
		    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_pray_for_armor (byte level, struct char_data *ch, char *arg, int type,
		     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_self_heal (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_restore_move (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_heal (byte level, struct char_data *ch, char *arg, int type,
	   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_full_heal (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_entire_heal (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_invisibility (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_locate_object (byte level, struct char_data *ch, char *arg, int type,
		    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_poison (byte level, struct char_data *ch, char *arg, int type,
	     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_protection_from_evil (byte level, struct char_data *ch, char *arg, int type,
			   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_haste (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_improved_haste (byte level, struct char_data *ch, char *arg, int type,
		     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_remove_curse (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_remove_poison (byte level, struct char_data *ch, char *arg, int type,
		    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_infravision (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_mirror_image (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
/* by process */
void
cast_death (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_sanctuary (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_love (byte level, struct char_data *ch, char *arg, int type,
	   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_reraise (byte level, struct char_data *ch, char *arg, int type,
	      struct char_data *tar_ch, struct obj_data *tar_obj)
{
  char tmpbuf[80];
...
void
cast_sleep (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
  int flag;
...
void
cast_strength (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_phase (byte level, struct char_data *ch, char *arg, int type,
	    struct char_data *tar_ch, struct obj_data *tar_obj)
{
...
void
cast_ventriloquate (byte level, struct char_data *ch, char *arg, int type,
		    struct char_data *tar_ch, struct obj_data *tar_obj)
{
...
void
cast_word_of_recall (byte level, struct char_data *ch, char *arg, int type,
		     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_summon (byte level, struct char_data *ch, char *arg, int type,
	     struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_far_look (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_relocate (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_charm_person (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
...
void
cast_sense_life (byte level, struct char_data *ch, char *arg, int type,
		 struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_identify (byte level, struct char_data *ch, char *arg, int type,
	       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_fire_breath (byte level, struct char_data *ch, char *arg, int type,
		  struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_frost_breath (byte level, struct char_data *ch, char *arg, int type,
		   struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_gas_breath (byte level, struct char_data *ch, char *arg, int type,
		 struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_lightning_breath (byte level, struct char_data *ch, char *arg, int type,
		       struct char_data *tar_ch, struct obj_data *tar_obj)
{
  switch (type)
    {
...
void
cast_reanimate (byte level, struct char_data *ch, char *arg, int type,
		struct char_data *tar_ch, struct obj_data *tar_obj)
{
