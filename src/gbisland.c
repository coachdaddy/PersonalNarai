...
void
gbisland_move_seashore (struct char_data *ch)
{
  int need_movement;
  int vnum_seashore;
...
int
gbisland_sea (struct char_data *ch, int cmd, char *arg)
{
  int was_in;
...
void
gbisland_false_move (struct char_data *ch, int dir)
{
  int was_in;
  char tmp[256];
  struct follow_type *k;
...
void
gbisland_go_out_barrier (struct char_data *ch)
{
  int was_in;
  char tmp[256];
  struct follow_type *k;
...
void
gbisland_go_back (struct char_data *ch)
{
  // int was_in;
  char tmp[256];
  int dir;
...
int
gbisland_saint_mirror (struct char_data *ch, int cmd, char *arg)
{
...
int
gbisland_lanessa (struct char_data *ch, int cmd, char *arg)
{
  static bool give;
...
int
gbisland_carpie (struct char_data *ch, int cmd, char *arg)
{
  int room;
...
int
gbisland_magic_paper (struct char_data *ch, int cmd, char *arg)
{
  char name[256];
  struct obj_data *obj;
  struct char_data *victim;
...
int
gbisland_seed_evil_power (struct char_data *ch, int cmd, char *arg)
{
  char name[256];
  struct obj_data *obj;
  int skno, skilled;
