...
*/
void
spell_spell_block (byte level, struct char_data *ch,
...
void
spell_reflect_damage (byte level, struct char_data *ch,
		      struct char_data *victim, struct obj_data *obj)
{
  struct affected_type af;
...
void
spell_dumb (byte level, struct char_data *ch,
	    struct char_data *victim, struct obj_data *obj)
{
  struct affected_type af;
...
void
spell_holy_shield (byte level, struct char_data *ch,
		   struct char_data *victim, struct obj_data *obj)
{
  struct affected_type af;
...
*/
void
spell_mana_transfer (byte level, struct char_data *ch,
		     struct char_data *victim, struct obj_data *obj)
{
  assert (ch);
...
*/
void
spell_kiss_of_process (byte level, struct char_data *ch,
		       struct char_data *victim, struct obj_data *obj)
{
...
void
spell_thunder_bolt (byte level, struct char_data *ch,
		    struct char_data *victim, struct obj_data *obj)
{
