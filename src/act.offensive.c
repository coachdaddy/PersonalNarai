...
void
do_hit (struct char_data *ch, char *argument, int cmd)
{
      ...
      if (victim)
	{
	  if (victim == ch)
		...
		return;
	      ...
	      if (ch && victim && IS_AFFECTED (ch, AFF_CHARM) && IS_AFFECTED
		  (victim, AFF_CHARM))
		{
		  return;
		}
...
void
do_kill (struct char_data *ch, char *argument, int cmd)
{
...
void
do_backstab (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
  byte percent;
...
void
do_order (struct char_data *ch, char *argument, int cmd)
{
...
void
do_flee (struct char_data *ch, char *argument, int cmd)
{
...
void
do_bash (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
  int percent;
...
void
do_rescue (struct char_data *ch, char *argument, int cmd)
{
...
void
do_multi_kick (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  int percent;
  int i;
...
void
do_kick (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
  int percent;
...
/* Perhaps made */
void
do_punch (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
  int dam;
...
void
do_tornado (struct char_data *ch, char *argument, int cmd)
{
...
void
do_light_move (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
...
void
do_flash (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
  int percent;
...
void
shoot (struct char_data *ch, struct char_data *victim, int type)
{
  byte percent;
  int dam;
...
void
do_shoot (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
  char name[256];
...
*/
void
do_temptation (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *victim;
