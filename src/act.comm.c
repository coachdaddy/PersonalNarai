...
/* 말하기 */
void
do_say (struct char_data *ch, char *argument, int cmd)
{
  int i;
...
void
do_sayh (struct char_data *ch, char *argument, int cmd)
{				/* hangul say */
  int i;
...
/* 외치기 */
void
do_shout (struct char_data *ch, char *argument, int cmd)
{
...
/* 얘기하기 */
void
do_tell (struct char_data *ch, char *argument, int cmd)
{
...
void
do_reply (struct char_data *ch, char *argument, int cmd)
{
...
/* 보내기 */
void
do_send (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *vict;
...
/*  그룹 말하기 */
void
do_gtell (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *k;
...
/* 속삭이기 */
void
do_whisper (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *vict;
...
/* 물어보기 */
void
do_ask (struct char_data *ch, char *argument, int cmd)
{
  struct char_data *vict;
  char name[100], message[MAX_INPUT_LENGTH], buf[MAX_OUTPUT_LENGTH];
...
void
do_lastchat (struct char_data *ch, char *argument, int cmd)
{
  /*struct descriptor_data *i;
...
/* 쓰기 */
void
do_write (struct char_data *ch, char *argument, int cmd)
{
