...
void
load_board (struct board_data *cb)
{
  int ind, m_num, size;
...
void
save_board (struct board_data *cb)
{
  int ind, m_num, size;
...
/* board main routine */
int
board (struct char_data *ch, int cmd, char *arg)
{
...
int
show_board (struct char_data *ch, struct board_data *cb, char *arg)
{
  int i;
...
int
remove_board (struct char_data *ch, struct board_data *cb, char *arg)
{
  int ind, msg;
...
int
read_board (struct char_data *ch, struct board_data *cb, char *arg)
{
...
int
write_board (struct char_data *ch, struct board_data *cb, char *arg)
{
...
int
post_board (struct char_data *ch, struct board_data *cb, char *arg)
{
