...
show_char_to_char (struct char_data *i, struct char_data *ch, int mode)
{
  ...
  if (mode == 0)
      ...
      if (found)
	{
      ...
      if (((GET_CLASS (ch) == CLASS_THIEF) && (ch != i)) || (GET_LEVEL (ch)
							     >= IMO))
	{
	  found = FALSE;
...
void
do_look (struct char_data *ch, char *argument, int cmd)
{
  char buffer[MAX_STRING_LENGTH];
...
void
do_bank (struct char_data *ch, char *argument, int cmd)
{
...
void
do_read (struct char_data *ch, char *argument, int cmd)
{
  char buf[100];
...
void
do_examine (struct char_data *ch, char *argument, int cmd)
{
...
void
do_report (struct char_data *ch, char *argument, int cmd)
{
  char buf[80];
...
void
do_exits (struct char_data *ch, char *argument, int cmd)
{
  int door;
  char buf[MAX_STRING_LENGTH];
  static char *exits[] =
...
void
do_score (struct char_data *ch, char *argument, int cmd)
{
  ...
  if (GET_LEVEL (ch) > 12)
    {
      ...
      sprintf (buf,
	       ...
	       saving_throws[GET_CLASS (ch) - 1][SAVING_PARA][GET_LEVEL (ch)
							      - 1],
	       IS_NPC (ch) ?
...
/* From msd mud : cyb */
void
do_attribute (struct char_data *ch, char *argument, int cmd)
{
  char buf[MAX_STRING_LENGTH];
  struct affected_type *aff;
  extern char *spells[];
...
void
do_time (struct char_data *ch, char *argument, int cmd)
{
  char buf[100], *suf;
  int weekday, day;
...
void
do_weather (struct char_data *ch, char *argument, int cmd)
{
...
void
do_help (struct char_data *ch, char *argument, int cmd)
{
...
void
do_spells (struct char_data *ch, char *argument, int cmd)
{
...
void
do_who (struct char_data *ch, char *argument, int cmd)
{
...
void
do_users (struct char_data *ch, char *argument, int cmd)
{
...
void
do_inventory (struct char_data *ch, char *argument, int cmd)
{
...
void
do_equipment (struct char_data *ch, char *argument, int cmd)
{
  int j;
  bool found;
...
void
do_credits (struct char_data *ch, char *argument, int cmd)
{

  page_string (ch->desc, credits, 0);
}
void
do_news (struct char_data *ch, char *argument, int cmd)
{
  page_string (ch->desc, news, 0);
}
void
do_plan (struct char_data *ch, char *argument, int cmd)
{
  page_string (ch->desc, plan, 0);
}
void
do_wizards (struct char_data *ch, char *argument, int cmd)
{
  page_string (ch->desc, wizards, 0);
}
void
do_where (struct char_data *ch, char *argument, int cmd)
{
...
void
do_levels (struct char_data *ch, char *argument, int cmd)
{
  int i;
  char buf[MAX_STRING_LENGTH];
  extern struct title_type titles[4][IMO + 4];
...
void
do_consider (struct char_data *ch, char *argument, int cmd)
{
...
void
do_police (struct char_data *ch, char *argument, int cmd)
{
  char name[200];
  struct descriptor_data *d;
  int i, target;
...
void
do_data (struct char_data *ch, char *argument, int cmd)
{
  struct descriptor_data *d;
  struct char_data *victim;
...
void
do_solo (struct char_data *ch, char *argument, int cmd)
{
  if (IS_NPC (ch))
    return;
