...
void assign_command_pointers(void)
{
    ...
    COMMANDO(82, POSITION_RESTING, do_replacerent, IMO + 3, IMO + 3, IMO + 3, IMO + 3);
    ...
    COMMANDO(149, POSITION_STANDING, do_extractrent, IMO + 2, IMO + 2, IMO + 2, IMO + 2);
    ...
    COMMANDO(241, POSITION_FIGHTING, do_demote, IMO + 3, IMO + 3, IMO + 3, IMO + 3);
