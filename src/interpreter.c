...
void
no_echo_telnet (struct descriptor_data *d)
{
  char buf[5];
...
void
echo_telnet (struct descriptor_data *d)
{
  char buf[5];
...
int
improve_status (struct char_data *ch, char arg)
{
  int is_possible = 1;
...
void
query_status (struct descriptor_data *d)
{
  char buf[128];
  struct char_data *ch;
