...
long int
mana_limit (struct char_data *ch)
{
  int extra[7] =
  {1, 2, 3, 4, 3, 2, 1};
  long int max;
...
long int
move_limit (struct char_data *ch)
{
  int extra[7] =
  {1, 2, 4, 8, 4, 2, 1};
  long int max;
...
void
advance_level (struct char_data *ch, int level_up)
{
