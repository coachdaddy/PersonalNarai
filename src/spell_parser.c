...
int
use_mana (struct char_data *ch, int sn)
{
  int min;
  int lev;
...
void
do_cast (struct char_data *ch, char *argument, int cmd)
{
...
void
SPELLO (int nr, byte beat, byte pos, int l0, int l1, int l2, int l3,
