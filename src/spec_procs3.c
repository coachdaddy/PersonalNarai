...
int
level_gate (struct char_data *ch, int cmd, char *arg)
{
  char buf[100];
  int f, r;
...
int
neverland (struct char_data *ch, int cmd, char *arg)
{
  int location, loc_nr;
...
int
helper (struct char_data *ch, int cmd, char *arg)
{
...
int
electric_shock (struct char_data *ch, int cmd, char *arg)
{
...
int
great_mazinga (struct char_data *ch, int cmd, char *arg)
{
  int tmp;
...
int
string_machine (struct char_data *ch, int cmd, char *arg)
{
  struct obj_data *obj;
  char buf[256];
...
int
slot_machine (struct char_data *ch, int cmd, char *arg)
{
  int num[3];
  int same;
  char buf[256];
